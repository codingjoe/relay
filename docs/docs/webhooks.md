...
```json
{
  ...
  "body_url": "https://storage.relays.to/relay/messages/%3Cab12%40example.net%3E.eml?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=...&X-Amz-Expires=3600&X-Amz-Signature=...",
  "spam_score": 1.5,
