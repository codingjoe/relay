...
STARTTLS. The MX presents a certificate that matches the MX hostname your records
publish, `mx1.relay.example.com` for the example platform domain, so senders
