...
from tx_mail.views import MergedMessagesRedirectView, MergedReportsRedirectView
    ...
    path(
        ...
        include(
            [
                path(
                    "",
                    MergedMessagesRedirectView.as_view(direction="received"),
                    name="inbox",
                ),
                path(
                    "<uuid:pk>",
    ...
    path(
        ...
        include(
            [
                path(
                    "",
                    MergedReportsRedirectView.as_view(report_type="tls"),
