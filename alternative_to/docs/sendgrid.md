...
| Incoming mail                                                                                                                                                                                                           | <i data-lucide="circle-check" class="size-4 text-success" aria-hidden="true"></i> MX + webhooks               | <i data-lucide="circle-dashed" class="size-4 text-muted-foreground" aria-hidden="true"></i> Inbound Parse (add-on) |
| EU data sovereignty                                                                                                                                                                                                     | <i data-lucide="circle-check" class="size-4 text-success" aria-hidden="true"></i> EU, GDPR                    | <i data-lucide="circle-x" class="size-4 text-destructive" aria-hidden="true"></i> US-owned (EU on higher tiers)    |
