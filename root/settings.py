...
RELAY_SMTP_BALANCER_PORT = env.int("RELAY_SMTP_BALANCER_PORT", default=0)

RELAY_MX_PORTS = (25,)
RELAY_MX_TLS_CERT_PATH = env("RELAY_MX_TLS_CERT_PATH", default="")
RELAY_MX_TLS_KEY_PATH = env("RELAY_MX_TLS_KEY_PATH", default="")

RELAY_PROXY_PROTOCOL_TIMEOUT_SECS = env.float(
    "RELAY_PROXY_PROTOCOL_TIMEOUT_SECS", default=0
)
