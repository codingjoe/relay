...
RELAY_SMTP_SUBMISSION_PORTS = [
    int(p) for p in env.list("RELAY_SMTP_SUBMISSION_PORTS", default=[587, 465])
]
RELAY_SMTP_IMPLICIT_TLS_PORTS = [
    int(p) for p in env.list("RELAY_SMTP_IMPLICIT_TLS_PORTS", default=[465])
]
...
RELAY_MX_PORTS = [int(p) for p in env.list("RELAY_MX_PORTS", default=[25])]
RELAY_MX_IMPLICIT_TLS_PORTS = [
    int(p) for p in env.list("RELAY_MX_IMPLICIT_TLS_PORTS", default=[465])
]
...
RELAY_PROXY_PROTOCOL_TIMEOUT = env.int("RELAY_PROXY_PROTOCOL_TIMEOUT", default=5)
